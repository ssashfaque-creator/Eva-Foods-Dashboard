...
def vocabulary_for_prompt() -> str:
    ...
    parts = [
        ...
        *_group(OIL_TYPE_ALIASES),
        ...
        "  row_dimensions=[\"party\"].",
        "- least/lowest gains (no last-year language) → metrics=[\"ams_growth\"],",
        "  sort_order=asc.",
        "- biggest gains (no last-year language) → metrics=[\"ams_growth\"],",
        "  sort_order=desc.",
        "- last N months vs the same N months last year / YoY of a spoken",
        "  window → metrics=[\"yoy\"], compare=\"yoy\" (NOT ams_growth).",
        "  last N vs the prior N months → metrics=[\"pop\"], compare=\"prior\".",
        "  lowest/least growth of that window → sort_order=asc;",
        "  highest/biggest → sort_order=desc.",
        "- Stacked cuts (volume > X AND growth < Y%) → metric_filters AND;",
        "  party rows; no month columns. 'less than 5% in AMS' is yoy/",
        "  ams_growth, not ams < 5. 'more than 10 MT AMS' is ams>10",
        "  (3-month AMS KPI), not volume>10. Do not switch metric to yoy_ams.",
        ...
        "- Growth vs prior 3-month AMS window → metrics=[\"ams_growth\"].",
