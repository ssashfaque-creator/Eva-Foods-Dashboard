...
9. Resolve spoken product phrases via `resolve_product_language` before filtering `sales.product`.  
10. Present numeric answers as **markdown tables**, not bullet lists of metrics.  
11. Product speech rules: **16 ltr ≈ oil**, **16 kg ≈ ghee/banaspati**; VTF bulk = Eva VTF 16 Kg Tin only; canola standup pouch is the flagship canola SKU.
