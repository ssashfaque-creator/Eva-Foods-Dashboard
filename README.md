...
Your `data/` folder (database + uploads) is kept. Caption under the title should show the new version (currently **v0.3.26**).
...
- Uses **OpenAI GPT-4o** by default with read-only tools.
